...
cur.execute("""CREATE TABLE IF NOT EXISTS archive_users(
    changing_id PRIMARY KEY,
    userid INT, 
    name TEXT,
    budget REAL,
    f_plan_n REAL,
    ...
    changing_date TEXT,
    changing_time TEXT)
""")  # генерируем архивную таблицу c данными о пользователе
conn.commit()
...
cur.execute("""CREATE TABLE IF NOT EXISTS archive_expenses(
    changing_id PRIMARY KEY,
    exp_id INT,
    userid INT,
    category_name TEXT,
    ...
    changing_date TEXT,
    changing_time TEXT)
""")  # генерируем архивную таблицу расходов
